...
class SellingBarcChart extends StatefulWidget {
  const SellingBarcChart({super.key});

  @override
  State<SellingBarcChart> createState() => _SellingBarcChartState();
}

class _SellingBarcChartState extends State<SellingBarcChart> {
  @override
  Widget build(BuildContext context) {
